...
Revision ID: 5b057b320aa6
Revises: 96878b29ffa2
Create Date: 2019-11-16 13:00:58.622557
...
revision = '5b057b320aa6'
down_revision = '96878b29ffa2'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('username', 'itemName')
    )
