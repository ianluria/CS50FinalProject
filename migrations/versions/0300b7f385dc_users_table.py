...
Revision ID: 0300b7f385dc
Revises: 
Create Date: 2019-11-07 14:40:20.720378
...
def upgrade():
    ...
    op.create_index(op.f('ix_user_item'), 'user', ['item'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_user_item'), table_name='user')
